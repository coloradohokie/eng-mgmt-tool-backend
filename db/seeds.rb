...
task_cat1 = TaskTemplate.create({value: "Main", sort_id:1, active: true })
task_cat2 = TaskTemplate.create({value: "Proposal", sort_id:2, active: true })
task_cat3 = TaskTemplate.create({value: "Foundation", sort_id:3, active: true })
task_cat4 = TaskTemplate.create({value: "Framing", sort_id:4, active: true })
